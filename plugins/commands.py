...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('𝙿𝚁𝙸𝚅𝙰𝚃𝙴 𝙱𝙾𝚃', url=f"https://t.me/Rohit_Codex")
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHΛИИΞL 💠', url='https://t.me/codexsupport_backup'),
            InlineKeyboardButton('💠 GROUP🥇 💠', url='https://t.me/codex_requestingMovies')
            ],[      
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
            ],[
            InlineKeyboardButton('✅ Codex  ✅', url='https://t.me/botsmoviesender')
        ]]         
        reply_markup = InlineKeyboardMarkup(buttons)        
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('Group', url='https://t.me/codex_requestingMovies') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
